...
from Manager.modules.sql.users_sql import get_all_users
import Manager.modules.sql.users_sql as sql

from Manager import dispatcher, OWNER_ID, LOGGER, DEV_USERS
